...
use Keletos\Component\Event\IObservable;
use Keletos\Component\Event\IObserver;

abstract class Component implements IObservable, IObserver {
...
//		}
    ...
    public function onEvent(IObservable $source, $event, array &$params = array()) {
        // Override onEvent() method in child class if required.
    }
